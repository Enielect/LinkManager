...
const SignUpPage = () => {
  return (
    <div className='bg-[#310f5c] text-white h-full flex flex-col sm:flex-row'>
      <div className='block w-screen md:w-[70vw] sm:w-[60vw] lg:w-[50vw]'>
        <Image
          alt='background'
        ...
        <Image
          ...
          src='/bg_img_2.png'
        />
        <span className='uppercase sm:hidden absolute text-2xl bottom-1/2 left-10'>
          Link sync
        </span>
      </div>

      <div className='px-10 w-full md:w-[30vw] sm:w-[50vw] lg:w-[35vw] sm:flex sm:flex-col mx-auto sm:justify-center signup-img-shadow'>
        <div className=' border-b  border-b-gray-50/10 pb-5'>
          <h2 className='py-2'>Sign in with email address</h2>
          <div className='relative'>
            ...
            <Input
              className='!py-5 bg-[#190733] border-none pl-10'
              placeholder='yourname@gmail.com'
            />
          </div>
          <Button className='w-full mt-4 rounded-lg py-5 signup-gradient'>
            Sign Up
          </Button>
        </div>
        <div className='space-y-2'>
          <h2 className='pt-3'>or continue with </h2>
          <div className='flex '>
            <Button className='basis-1/2 flex items-center bg-[#3B2063]'>
              <svg
                width='16'
                height='17'
                viewBox='0 0 16 17'
          ...
          <span className='text-xs sm:text-sm  text-[#B6B6B6] '>
            By registering you agree to our{' '}
            <span className='text-[#9D5CE9]'>terms and conditions</span>
          </span>
        </div>
      </div>
    </div>
